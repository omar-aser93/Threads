// Resource: https://docs.uploadthing.com/getting-started/appdir#creating-your-first-fileroute
...
const getUser = async () => await currentUser();   //clerk get currentUser() function
