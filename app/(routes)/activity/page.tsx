...
import { fetchUser, getActivity } from "@/lib/server_actions/user.actions";
...
async function Page() {
  ...
  //getActivity Server_action to get current user Activities by his DB id
  ...
  return (
    <>
      ...
      {/* if there's comments Activity, Map through them to show a notifications of other users commenting on your posts */}
